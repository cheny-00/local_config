...
" ── Buffer & Tab navigation (Alt-free: AeroSpace eats most <M-…> keys) ──
" Buffers: cycle with ]b / [b (mirrors nvim 0.12), close with <leader>bc.
nnoremap <silent> ]b :bnext<CR>
nnoremap <silent> [b :bprevious<CR>
nnoremap <silent> <leader>bc :bdelete<CR>
" Jump straight to buffer N shown in the airline tabline (needs buffer_idx_mode).
...
" Tabs: tn new / tk next / tj prev / to only (mirrors nvim).
" NOTE: this makes the `t` motion wait briefly for n/j/k/o (e.g. `to` shadows till-o).
...
let g:airline#extensions#tabline#buffer_idx_mode = 1  " number buffers for <leader>1-9 jump
...
" vim-markdown: don't auto-fold markdown files.
